		...
		foreach($users as $user_id) {
			...
			if(function_exists('get_field')) {
				...
				if( get_field('t2_2019_april_actual', $user_acf_id)) {
					...
					$data[$i]['01/04/2019'] = get_field('t2_2019_april_actual', $user_acf_id);
				...
				if( get_field('t2_2019_may_actual', $user_acf_id)) {
					...
					$data[$i]['periods']['t2_2019_may_actual'] = get_field('t2_2019_may_actual', $user_acf_id);

				}

				if( get_field('t2_2019_june_actual', $user_acf_id)) {
				
					$data[$i]['periods']['t2_2019_june_actual'] = get_field('t2_2019_june_actual', $user_acf_id);

				}

				if( get_field('t2_2019_july_actual', $user_acf_id)) {
					
					$data[$i]['periods']['t2_2019_jul_actual'] = get_field('t2_2019_july_actual', $user_acf_id);
				...
				if( get_field('t3_2019_august_actual', $user_acf_id)) {
					...
					$data[$i]['periods']['t3_2019_august_actual'] = get_field('t3_2019_august_actual', $user_acf_id);

				}

				if( get_field('t3_2019_september_actual', $user_acf_id)) {

					$data[$i]['periods']['t3_2019_september_actual'] = get_field('t3_2019_september_actual', $user_acf_id);

				}

				if( get_field('t3_2019_october_actual', $user_acf_id)) {	

					$data[$i]['periods']['t3_2019_october_actual'] = get_field('t3_2019_october_actual', $user_acf_id);

				}

				if( get_field('t3_2019_november_actual', $user_acf_id)) {	

					$data[$i]['periods']['t3_2019_november_actual'] = get_field('t3_2019_november_actual', $user_acf_id);
				...
				if( get_field('t1_2020_december_actual', $user_acf_id)) {
					...
					$data[$i]['periods']['t1_2020_december_actual'] = get_field('t1_2020_december_actual', $user_acf_id);

				}

				if( get_field('t1_2020_january_actual', $user_acf_id)) {

					$data[$i]['periods']['t1_2020_january_actual'] = get_field('t1_2020_january_actual', $user_acf_id);

				}

				if( get_field('t1_2020_february_actual', $user_acf_id)) {	
					$data[$i]['periods']['t1_2020_february_actual'] = get_field('t1_2020_february_actual', $user_acf_id);

				}

				if( get_field('t1_2020_march_actual', $user_acf_id)) {

					$data[$i]['periods']['t1_2020_march_actual'] = get_field('t1_2020_march_actual', $user_acf_id);
				...
				if( get_field('t2_2020_april_actual', $user_acf_id)) {
					...
					$data[$i]['periods']['t2_2020_april_actual'] = get_field('t2_2020_april_actual', $user_acf_id);

				}

				if( get_field('t2_2020_may_actual', $user_acf_id)) {

					$data[$i]['periods']['t2_2020_may_actual'] = get_field('t2_2020_may_actual', $user_acf_id);
				}

				if( get_field('t2_2020_june_actual', $user_acf_id)) {

					$data[$i]['periods']['t2_2020_june_actual'] = get_field('t2_2020_june_actual', $user_acf_id);

				}

				if( get_field('t2_2020_july_actual', $user_acf_id)) {

					$data[$i]['periods']['t2_2020_july_actual'] = get_field('t2_2020_july_actual', $user_acf_id);
				...
				if( get_field('t3_2020_august_actual', $user_acf_id)) {
					...
					$data[$i]['periods']['t3_2020_august_actual'] = get_field('t3_2020_august_actual', $user_acf_id);

				}

				if( get_field('t3_2020_september_actual', $user_acf_id)) {

					$data[$i]['periods']['t3_2020_september_actual'] = get_field('t3_2020_september_actual', $user_acf_id);
				}

				if( get_field('t3_2020_october_actual', $user_acf_id)) {

					$data[$i]['periods']['t3_2020_october_actual'] = get_field('t3_2020_october_actual', $user_acf_id);

				}

				if( get_field('t3_2020_november_actual', $user_acf_id)) {

					$data[$i]['periods']['t3_2020_november_actual'] = get_field('t3_2020_november_actual', $user_acf_id);
		...
		//foreach($users as $user_id) {
			...
			if(function_exists('get_field')) {
				...
				if( get_field('t2_2019_april_actual', $user_acf_id)) {
					...
					$data['periods']['t2_2019_april_actual'] = get_field('t2_2019_april_actual', $user_acf_id);

				}

				if( get_field('t2_2019_may_actual', $user_acf_id)) {
				
					$data['periods']['t2_2019_may_actual'] = get_field('t2_2019_may_actual', $user_acf_id);

				}

				if( get_field('t2_2019_june_actual', $user_acf_id)) {
				
					$data['periods']['t2_2019_june_actual'] = get_field('t2_2019_june_actual', $user_acf_id);

				}

				if( get_field('t2_2019_july_actual', $user_acf_id)) {
					
					$data['periods']['t2_2019_jul_actual'] = get_field('t2_2019_july_actual', $user_acf_id);
				...
				if( get_field('t3_2019_august_actual', $user_acf_id)) {
					...
					$data['periods']['t3_2019_august_actual'] = get_field('t3_2019_august_actual', $user_acf_id);

				}

				if( get_field('t3_2019_september_actual', $user_acf_id)) {

					$data['periods']['t3_2019_september_actual'] = get_field('t3_2019_september_actual', $user_acf_id);

				}

				if( get_field('t3_2019_october_actual', $user_acf_id)) {	

					$data['periods']['t3_2019_october_actual'] = get_field('t3_2019_october_actual', $user_acf_id);

				}

				if( get_field('t3_2019_november_actual', $user_acf_id)) {	

					$data['periods']['t3_2019_november_actual'] = get_field('t3_2019_november_actual', $user_acf_id);
				...
				if( get_field('t1_2020_december_actual', $user_acf_id)) {
					...
					$data['periods']['t1_2020_december_actual'] = get_field('t1_2020_december_actual', $user_acf_id);

				}

				if( get_field('t1_2020_january_actual', $user_acf_id)) {

					$data['periods']['t1_2020_january_actual'] = get_field('t1_2020_january_actual', $user_acf_id);

				}

				if( get_field('t1_2020_february_actual', $user_acf_id)) {	
					$data['periods']['t1_2020_february_actual'] = get_field('t1_2020_february_actual', $user_acf_id);

				}

				if( get_field('t1_2020_march_actual', $user_acf_id)) {

					$data['periods']['t1_2020_march_actual'] = get_field('t1_2020_march_actual', $user_acf_id);
				...
				if( get_field('t2_2020_april_actual', $user_acf_id)) {
					...
					$data['periods']['t2_2020_april_actual'] = get_field('t2_2020_april_actual', $user_acf_id);

				}

				if( get_field('t2_2020_may_actual', $user_acf_id)) {

					$data['periods']['t2_2020_may_actual'] = get_field('t2_2020_may_actual', $user_acf_id);
				}

				if( get_field('t2_2020_june_actual', $user_acf_id)) {

					$data['periods']['t2_2020_june_actual'] = get_field('t2_2020_june_actual', $user_acf_id);

				}

				if( get_field('t2_2020_july_actual', $user_acf_id)) {

					$data['periods']['t2_2020_july_actual'] = get_field('t2_2020_july_actual', $user_acf_id);
				...
				if( get_field('t3_2020_august_actual', $user_acf_id)) {
					...
					$data['periods']['t3_2020_august_actual'] = get_field('t3_2020_august_actual', $user_acf_id);

				}

				if( get_field('t3_2020_september_actual', $user_acf_id)) {

					$data['periods']['t3_2020_september_actual'] = get_field('t3_2020_september_actual', $user_acf_id);
				}

				if( get_field('t3_2020_october_actual', $user_acf_id)) {

					$data['periods']['t3_2020_october_actual'] = get_field('t3_2020_october_actual', $user_acf_id);

				}

				if( get_field('t3_2020_november_actual', $user_acf_id)) {

					$data['periods']['t3_2020_november_actual'] = get_field('t3_2020_november_actual', $user_acf_id);
